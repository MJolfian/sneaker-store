...
const mainLastBtn=document.querySelector('#main-last-btn');
export const userNameInput=document.getElementById('username');  // to signup.js & login.js
export const passwordInput=document.getElementById('password');  // to signup.js & login.js
export const form=document.querySelector('form');  // to signup.js & login.js 
export let usernameErr=form.querySelector('#username-err');  // to error-handler.js
export let passwordErr=form.querySelector('#password-err');  // to error-handler.js
export let sysErr=form.querySelector('#sys-err');  // to error-handler.js
export const backSvg=document.getElementById('backSvg');  // to signup.js & login.js
let isVisible=false;
...
form.addEventListener('input',()=>{
	mainLastBtn.disabled = userNameInput.value === '' || passwordInput.value === ''; // the output is a boolean.  or: ↓
//	if(userNameInput.value==='' || passwordInput.value===''){
//		mainLastBtn.disabled=true;
//	}else{
//		mainLastBtn.disabled=false;
//	}
});